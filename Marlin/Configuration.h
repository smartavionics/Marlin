...
#define STRING_CONFIG_H_AUTHOR "(jcrocholl, Mini Kossel, T3P3, MB)" // Who made the changes.
...
#define DELTA_DIAGONAL_ROD 213.07 // mm (mb)

// Horizontal offset from middle of printer to smooth rod center.
#define DELTA_SMOOTH_ROD_OFFSET 145.0 // mm (t3p3)

// Horizontal offset of the universal joints on the end effector.
#define DELTA_EFFECTOR_OFFSET 19.9 // mm (t3p3)
...
#define DEFAULT_MAX_FEEDRATE          {1000, 1000, 1000, 800}    // (mm/sec) (T3P3)
